...
public interface IInstantlyLeadUtil
{
    ...
    /// <summary>
    /// Safely deletes specified emails from a campaign or globally, with an option to delete all leads from the company.
    /// </summary>
    ...
    ValueTask<InstantlyOperationResponse?> DeleteSafe(List<string> emails, bool deleteAllFromCompany = false, string? campaignId = null);
